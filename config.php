...
$nav_items = [
    ...
    ['label' => 'Chat', 'icon' => 'fa-regular fa-comments', 'badge' => true, 'url' => 'chat.php'],
    ['label' => 'Content', 'icon' => 'fa-regular fa-newspaper', 'url' => 'content.php'],
    ['label' => 'Promotions', 'icon' => 'fa-solid fa-bullhorn', 'url' => 'promotions.php'],
